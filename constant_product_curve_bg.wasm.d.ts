...
export function __wbg_constantproductwasm_free(a: number): void;
export function constantproductwasm_init(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function constantproductwasm_k_from_xy(a: number, b: number, c: number): void;
export function constantproductwasm_spot_price_from_pair(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_xy_deposit_amounts_from_l(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function constantproductwasm_x2_from_y_swap_amount(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_y2_from_x_swap_amount(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_delta_x_from_y_swap_amount(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_delta_y_from_x_swap_amount(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_k(a: number, b: number): void;
export function constantproductwasm_spot_price_x(a: number, b: number): void;
export function constantproductwasm_spot_price_y(a: number, b: number): void;
export function constantproductwasm_swap_unsafe(a: number, b: number, c: number, d: number): void;
export function constantproductwasm_swap(a: number, b: number, c: number, d: number, e: number): void;
export function constantproductwasm_deposit_liquidity_unsafe(a: number, b: number, c: number, d: number, e: number): void;
export function constantproductwasm_withdraw_liquidity_unsafe(a: number, b: number, c: number, d: number, e: number): void;
export function constantproductwasm_deposit_liquidity(a: number, b: number, c: number, d: number, e: number): void;
export function constantproductwasm_withdraw_liquidity(a: number, b: number, c: number, d: number, e: number): void;
...
export function constantproductwasm_xy_withdraw_amounts_from_l(a: number, b: number, c: number, d: number, e: number, f: number): void;
